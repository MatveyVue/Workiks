...
<button class="all"><b>Program</b><div class="line"></div></button>
<button style="margin-left: 30px;" class="all"><RouterLink style="text-decoration: none; color: inherit;" to="/ads">Ads</RouterLink></button>
        
        
<center>
<h1><img class="img" src="https://i.postimg.cc/26QCcck3/67-B1-E738-5-B68-439-E-9-FF9-168-D68-BEAA73.png" width="250px"></h1>
<h2>There are no ads available</h2>
</center>
</template>
